...
const TripCard = ({ from, to, date, time, price, image }: TripCardProps) => {
  return (
    <div className="bg-[#1B75BC]/10 backdrop-blur-lg border border-[#1B75BC]/20 shadow-lg rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:translate-y-[-4px] animate-fade-up">
      <div className="w-full h-[300px] overflow-hidden relative group">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1B75BC]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
      <div className="p-8">
